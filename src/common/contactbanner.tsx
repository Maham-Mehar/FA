      ...
      <div className="relative z-10 w-full px-4 lg:px-8">
        <div className="flex flex-col md:flex-row items-center justify-between gap-8 md:gap-10 max-w-4xl mx-auto py-8 md:py-10">
          ...
          <div className="flex flex-col gap-4 w-full md:w-auto">
            <button className="flex items-center gap-2 lg:px-6 px-4 py-3 bg-zink text-white rounded-lg shadow hover:bg-[#D6AB62] font-medium transition">              <FaPhoneAlt />
              Tel: +66 61 234 5623
            </button>
            <button className="flex items-center gap-2 lg:px-6 px-4 py-3 bg-zink text-white rounded-lg shadow hover:bg-[#D6AB62] font-medium transition">
              <FaWhatsapp />
