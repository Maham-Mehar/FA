...
const attractionsData: DestinationAttractions = {
  "phi-phi-island": {
    headingText: "Main Attractions on Phi Phi Islands",
    items: [
      {
      ...
      },
      {
        ...
        highlights: [
          "Long-tailed macaques in their natural habitat",
          "Coral reefs just offshore",
          "Towering limestone cliffs framing the beach",
        ],
        tip: "Visit early for calm seas, fewer boats, and a peaceful wildlife encounter.",
      },
      {
        id: "04",
        ...
        highlights: [
          "Sweeping views of Tonsai and Loh Dalum bays",
          "A vibrant sunrise or quiet midday escape",
          "Tropical plants and wildlife along the trail",
        ],
        tip: "Go early at 5 AM for sunrise serenity, or try midday for fewer tourists—but be prepared for the heat.",
      },
      {
        id: "05",
        ...
        highlights: [
          "Leopard sharks, reef sharks & manta rays",
      ...
      },
      {
        ...
        highlights: [
          "Beautiful coral reefs & marine life at Hin Klang",
      ...
      },
      {
        ...
        highlights: [
          "Skilled fire dancers performing to music",
