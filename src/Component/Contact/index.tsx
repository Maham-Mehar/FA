            ...
            <section className="bg-white py-12 px-4 lg:px-6 ">
                <div className="max-w-7xl mx-auto bg-white p-0 xl:p-6 grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-8 xl:gap-12">
                    ...
                    <div className="col-span-12 lg:col-span-7">
                        <h2 className="text-[32px] sm:text-[36px] font-playfair font-bold text-[#034250] mb-4">
                            Get In Touch
                        </h2>
                        <form
                    ...
                    <div className="col-span-12 lg:col-span-5 bg-[url('/images/contactbg.png')] bg-cover bg-center bg-no-repeat bg-opacity-90 backdrop-blur-md p-6 shadow-sm rounded-tl-3xl rounded-br-3xl">
                        ...
                        <p className="text-zink mb-4 text-[18px] md:text-[20px] lg:text-[22px] xl:text-[24px] font-normal">
                            Want help planning your adventure? </p>
                        <p className="text-[16px] md:text-[18px] lg:text-[20px] xl:text-[22px] font-normal"> <span className="font-bold">Fill out </span>Fill out the form and one of our
                                ...
                                return (
                                    <li key={index} className="flex items-start gap-3">
                                        <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4 sm:gap-6">
                                            ...
                                            <div>
                                                <p className="text-[20px] sm:text-[22px] md:text-[24px] font-sourceSanspro font-semibold text-[#034250]">
                                                    {item.title}
                                                </p>
