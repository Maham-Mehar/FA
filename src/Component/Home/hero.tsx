...
const HeroSection = () => {
    return (
        <div className="relative w-full ">
            ...
            <section className="relative w-full bg-[#0061B1]/25 bg-[url('/images/homeimg1.png')] bg-cover bg-center bg-no-repeat overflow-hidden min-h-[45vh] md:min-h-[80vh] lg:min-h-[72vh] xl:min-h-[82vh] flex items-center justify-center">
                {/* Content on top */}
