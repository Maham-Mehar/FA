  ...
  return (
    <section className="bg-white py-4 md:py-9 lg:py-12 xl:py-16 px-4 xl:px-0">
      ...
      <div className="text-center mb-[40px]">
        <HeadingContent
          heading="Sailing Moments to Remember"
          description="A collection of memories from guests who turned dreams into voyages"
        />
      </div>
      ...
      <div className="max-w-7xl mx-auto flex flex-col gap-2 md:gap-2 lg:gap-3 xl:gap-4 items-center mt-8">
        ...
        <div className="flex flex-row gap-1 md:gap-2 lg:gap-4">
          ...
          <div className="-mt-[55px] md:-mt-[65px] lg:-mt-[75px] xl:-mt-[82px] hidden md:block">
