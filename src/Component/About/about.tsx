        ...
        <div className="max-w-7xl mx-auto my-18">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-16">
                <div>
                    ...
                    <p className="text-[40px] font-bold font-playfair text-zink mb-3 uppercase">Our Story</p>
                    <p className="texty-[22px] text-zink font-normal text-inter">Faraway Yachting began in 1996 when four passionate sailors from Austria, Norway, Australia, and the Netherlands met by chance at Kata Beach. What started as a sunset chat turned into a bold venture—offering sailing and scuba trips across Thailand, Myanmar, and even the remote Andaman Islands.<br />
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-16 mt-14">
                ...
                <div >
                    ...
                    <p className="text-[40px] font-bold font-playfair text-zink mb-3 uppercase"> Our Mission</p>
                    <p className="texty-[22px] text-zink font-normal text-inter">At Faraway Yachting, our mission is simple — create unforgettable, safe, and sustainable yacht adventures that bring joy to our guests and pride to our crew.<br />
