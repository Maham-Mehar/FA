  ...
  <section className="relative bg-white py-7 lg:py-10 overflow-hidden">
    ...
    <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6">
      <div className="text-center mb-12 md:mb-16">
        <h2 className="text-2xl sm:text-3xl md:text-[40px] font-playfair font-bold text-mustard mb-4">Private Yacht in Phuket</h2>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-5 md:gap-8 lg:gap-11 xl:gap-14 items-center">
        <div className="w-full">
          <Image src={PngIcons.privateyact} alt="Mission" width={590} height={590} className="w-full h-auto object-cover" />
        </div>
        <div>
