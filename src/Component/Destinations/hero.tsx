const HeroSection = () => {
  return (
    <div>
      ...
      <p className="text-center text-[#034250] font-sourceSansPro text-base sm:text-lg md:text-xl font-normal max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-10 sm:py-12 leading-relaxed">
