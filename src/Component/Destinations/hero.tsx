...
const HeroSection = () => {
    ...
    return (
        <div>
            <div className="bg-[url('/images/hero.png')] bg-cover bg-center bg-no-repeat min-h-[50vh] sm:min-h-[58vh] md:min-h-[58vh] flex flex-col justify-center items-center ">
                <div className="text-center ">
                    <p className="text-white text-[28px] font-extrabold">DESTINATIONS</p>
                    <p className="text-white text-[56px] pt-4 font-normal">Our Destinations In Phuket</p>
                </div>
            </div>
