...
import { forgetUser } from "@/lib/features/auth/forgetslice";
...
const OtpVerificationForm: React.FC<OtpVerificationFormProps> = ({ onNext, context }) => {
        ...
        onSubmit: async (values, { resetForm, setSubmitting, setFieldError }) => {
            ...
            try {
                const resultAction = await dispatch(
                    otpUser({ email: storedEmail, otp: Number(otpString), mode: context === "signup" ? "signup" : "forget" })
                );
    ...
    // Handle input focus for backspace
    ...
    return (
        <form onSubmit={formik.handleSubmit} className="flex flex-col justify-between h-[37.8rem]">
            <ToastContainer position="top-right" autoClose={3000} />
            <div className="px-10 xl:px-12 space-y-5">
