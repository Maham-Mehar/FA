...
import { resetUser } from "@/lib/features/auth/resetslice";
...
const ResetPasswordForm: React.FC<ResetPasswordFormProps> = ({ onNext }) => {
    ...
    const formik = useFormik({
        ...
        onSubmit: async (values, { resetForm, setSubmitting, setFieldError }) => {
            ...
            try {
                const resultAction = await dispatch(resetUser({
                    email: storedEmail,
                    password: values.password
                }));

                if (resetUser.fulfilled.match(resultAction)) {
                ...
                } else if (resetUser.rejected.match(resultAction)) {
    ...
    return (
        <form onSubmit={formik.handleSubmit} className="flex flex-col justify-between h-[37.8rem]">
            ...
            <div className="px-10 xl:px-12 space-y-6">
