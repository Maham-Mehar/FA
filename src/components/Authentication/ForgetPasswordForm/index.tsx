...
const ForgetPasswordForm: React.FC<ForgotPasswordFormProps> = ({ onNext, onSignup }) => {

    const dispatch = useDispatch<AppDispatch>();
    const { error } = useSelector((state: RootState) => state.forget);
    ...
    const formik = useFormik({
        ...
        onSubmit: async (values, { resetForm, setSubmitting, setFieldError }) => {
            try {
                const resultAction = await dispatch(forgetUser({
                    email: values.email,
                }));
